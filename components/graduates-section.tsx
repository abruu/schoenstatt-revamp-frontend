...
export function GraduatesSection() {
  ...
  const graduates = [
    {
      title: "German B2 Exam Winners",
      date: "June 2025",
      type: "Telc Certification",
      description:
        "Congratulations to our outstanding B2 level graduates who achieved excellent scores in their Telc examinations.",
      studentCount: 16,
      successRate: "100%",
      level: "B2",
    ...
    {
      title: "A2 Level Graduates",
      date: "April 2025",
      type: "Course Completion",
      description:
        "Celebrating the successful completion of A2 level German language course by our dedicated students.",
      studentCount: 24,
      successRate: "98%",
      level: "A2",
    ...
    <section className="space-y-16">
      <div className="text-center space-y-6">
        ...
        <h2 className="text-4xl lg:text-6xl font-bold">
          <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">SLA Graduates</span>
        </h2>
        ...
        {graduates.map((graduate, index) => (
          ...
          >
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden hover:bg-white/10 transition-all duration-500 hover:scale-105">
              {/* Header with icon */}
              <div className={`bg-gradient-to-r ${graduate.gradient} p-8 relative overflow-hidden`}>
                ...
                <div className="relative z-10 text-center space-y-4">
                  <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto">
                    <graduate.icon className="h-8 w-8 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-white">{graduate.title}</h3>
                  <div className="flex justify-center gap-3">
                    <Badge className="bg-white/20 text-white border-white/30">{graduate.date}</Badge>
                    <Badge className="bg-white/20 text-white border-white/30">Level {graduate.level}</Badge>
                  </div>
                </div>
                ...
                <div
                  className="absolute bottom-4 left-4 w-6 h-6 bg-white/10 rounded-full animate-pulse"
      ...
      <div className="text-center">
        <Button
          onClick={handleViewAllGraduates}
          variant="outline"
          size="lg"
