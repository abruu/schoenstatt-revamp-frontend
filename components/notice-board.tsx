...
import { X, Bell, Calendar, Users, Award, MapPin, ChevronRight } from "lucide-react"
...
export function NoticeBoard() {
  ...
  useEffect(() => {
    // Show notice board after page loads
  ...
  return (
    <div className="fixed top-24 right-6 z-40 max-w-sm animate-slide-in-right">
      <div className="relative">
        ...
        {/* Main notice board */}
        <div className="relative bg-black/80 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl">
          {/* Header */}
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              ...
              size="icon"
              className="w-6 h-6 bg-white/10 hover:bg-white/20 border-none"
            >
              <X className="h-4 w-4" />
            </Button>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {currentNoticeData.priority === "high" && (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    size="sm"
                    className={`bg-gradient-to-r ${currentNoticeData?.gradient?.className} text-white text-xs px-3 py-1 h-auto`}
                  >
                    Read More
