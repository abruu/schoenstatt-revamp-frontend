          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
                A1-B2 courses have a period of 10 months. We have a excellent
                faculty, among which we have priests, who were trained in
                Germany and have many years of experience studying and working
                in Germany. Our students learn not only the language, but also
                the German culture and life style, which are very important for
                those who aspire to go to Germany in order to work or to study
              </p>
            </div>
          ...
          <div className="relative">
            <div className="relative group">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  src="/images/Gallery/Our-Courses.jpg"
